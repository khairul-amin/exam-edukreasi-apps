...
// JANGAN panggil startDataWatchdog() secara otomatis di sini
// startDataWatchdog(); 
...
function startDataWatchdog() {
    ...
    // Jika dalam 20 detik data tidak muncul, tampilkan pesan gagal
    dataWatchdog = setTimeout(() => {
        const examGrid = document.getElementById('examGrid');
        // Hanya tampilkan jika grid kosong DAN tidak sedang menunggu login (misal ada indikator lain)
    ...
    }, 20000); // Tingkatkan ke 20 Detik agar lebih toleran
}
...
function updateExamList(userInfo, examList) {
    ...
    // Pastikan infoBox sembunyi saat data masuk
